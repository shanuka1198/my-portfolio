        ...
        <>
            <div className="flex flex-col">
                ...
                >
                    ...
                    >
                        <img src="/profile/my-pic-new.png" alt="My Picture"/>
                    </div>
                    <div className="flex justify-center">
                        <p className="sm:my-10 my-10 font-bold text-xl sm:text-6xl">
                ...
                >
                    ...
                    >
                        <p className="sm:text-xl text-sm w-[700px] p-5">
                            "I am <span className="sm:text-2xl text-xl text-yellow-600 font-bold">
                                Shanuka Imantha.
                            </span> I am a dedicated software engineer with experience in designing and developing
                            robust applications.
                            Proficient in multiple programming languages and frameworks, I thrive in collaborative
                            environments and am
                            passionate about problem-solving. With a keen eye for detail and a commitment to continuous
                            learning, I strive
                            to deliver high-quality software solutions that meet and exceed user expectations."
                        </p>
                    </div>
                </motion.div>
            </div>
